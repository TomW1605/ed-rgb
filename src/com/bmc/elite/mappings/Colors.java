...
public class Colors {
    ...
    public static final Integer[] OTHER = colorsToPercentArray(90, 25, 0);
    public static final Integer[] UI_ALT = colorsToPercentArray(255, 80, 0);
    public static final Integer[] UI = colorsToPercentArray(255, 115, 70);
