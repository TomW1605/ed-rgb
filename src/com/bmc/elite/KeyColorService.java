...
public class KeyColorService {
    ...
    public void setToggleKeyColors(Status newStatus) {
        ...
        dimEliteKeyFromColorArray(eliteBindings.get(Controls.IncreaseSystemsPower).get(0), MAIN_CONTROLS.get(Controls.IncreaseSystemsPower), m*newStatus.Pips[0]+c);
        dimEliteKeyFromColorArray(eliteBindings.get(Controls.IncreaseEnginesPower).get(0), MAIN_CONTROLS.get(Controls.IncreaseEnginesPower), m*newStatus.Pips[1]+c);
        dimEliteKeyFromColorArray(eliteBindings.get(Controls.IncreaseWeaponsPower).get(0), MAIN_CONTROLS.get(Controls.IncreaseWeaponsPower), m*newStatus.Pips[2]+c);
